...
//	int num_sclauses;
	...
	long long *clause_true_lit_thres;
...
//	long long ave_soft_weight;
	...
	struct large_data *sat_count;
//	int *sat_var;
	long long *clause_selected_count;
//	int *best_soft_clause;

    // variables used for initial solution
    int sizeOfQ;
    int *unchangable;
    int num_potential_clauses;
    bool * potential_clause;
    bool * init_solution;
    struct large_data* slack;
    long long* aMax;
    int** pos;
    queue<int> init_clauses;


    //variables used for verification
    lit **verify_clause_lit;
    int * verify_clause_count;
    long long * verify_clause_true_thresh;


    //variables used for analysis
    long long nrOfUnchangable;
